...
if(isset($_POST['submit'])){
    ...
    $sqy="insert into autoinvestment (id,investment_amount,clone_amount)values('$owner_id','$amount','$amount')";
...
<body>
      ...
      <header >
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color:rgba(6, 246, 45, 0.79); height:100px">
            <div class="container-fluid">
              <a class="navbar-brand" style="font-weight: bold;font-size: 30px;" href="Admin.php">UNI_INVEST</a>
  ...
  left: 500px;">
        ...
        <h1 class="text-center">AUTO INVESTMENT</h1>
        <form class="needs-validation" action="Autoinvestment.php" method="post" >

        
        
    <div class="form-outline mb-4">
  <label class="form-label" for="form2Example1">AMOUNT</label>
    <input type="text" id="form2Example1" class="form-control" name="amount"/>
         ...
         <button type="submit" name="submit" class="btn btn-primary" style="background-color:rgba(6, 246, 45, 0.79); width: 780px;">Submit</button>
