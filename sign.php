...
if(isset($_POST['submit'])){
    ...
    $sqy="insert into user (Legal_Name,service,country,email,password,Address,Age,Profession)values('$Legal_Name','$service','$country','$email','$password','$Address','$Age','$Profession')";
...
<body>
  ...
  left: 500px;">
        ...
        <form class="needs-validation" action="sign.php" method="post" >

        
        
    <div class="form-outline mb-4">
  <label class="form-label" for="form2Example1">Legal_Name</label>
    <input type="text" id="form2Example1" class="form-control" name="Legal_Name"/>
  ...
  <label class="form-label" for="form2Example1">country</label>
    <input type="text" id="form2Example1" class="form-control" name="country" />
  ...
  <label class="form-label" for="form2Example1">Age</label>
    <input type="text" id="form2Example1" class="form-control" name="Age"  />
    
  </div>
  <div class="form-outline mb-4">
  <label class="form-label" for="form2Example1">Profession</label>
    <input type="text" id="form2Example1" class="form-control" name="Profession"  />
    
         </div>
         <button type="submit" name="submit" class="btn btn-primary" style="background-color:rgba(6, 246, 45, 0.79);">Submit</button>
