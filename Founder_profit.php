...
<body>
  ...
  <div class="container-flud" >  
    ...
    <h1 class="text-center">Founder profit,</h1>     
 
  <form action="update_founder.php" method="post" enctype="multipart/form-data">
    <table class="table">
        <thead>
            <tr>
                <th scope="col">id</th>
...
$pic = mysqli_query($link,"SELECT * FROM founder_profit");
...
<td>'.$clone_amount.'</td>
<td>
<button class="btn btn-primary"><a href="update_founder.php?updateid='.$id.'" class="text-light">UPDATE</a></button>
</td>
</tr>';
}
?> 
