...
<body>
  ...
  <div class="container-flud" >  
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav" style="position: absolute;  right: 600px;">
                  <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="front_page.php">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="Learn.php">Learn</a>
                  </li>
    ...
    <img src="image\Group 88.png" class="img-fluid rounded" style="width: 2000px; height: 840px;" alt="My Image">
      ...
      <div class="section-title">
        ...
        <p style="font-size: 30px;">Growing to Reach Profitability
