...
<body>
  ...
  <form action="update_AutoInvest.php" method="post" enctype="multipart/form-data">
    <table class="table">
        <thead>
            <tr>
                <th scope="col">id</th>
...
$pic = mysqli_query($link,"SELECT * FROM autoinvestment");
...
<td>'.$clone_amount.'</td>
<td>
<button class="btn btn-primary"><a href="update_AutoInvest.php?updateid='.$id.'" class="text-light">UPDATE</a></button>
</td>
</tr>';
}
?> 
